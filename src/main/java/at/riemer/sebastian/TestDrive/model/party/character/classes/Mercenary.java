...
public class Mercenary implements CharacterClass {
    ...
    public Mercenary() {
        ...
        this.usingHeavyArmor = true;
        this.usingTwoWeaponBattleing = true;
        this.usingHeavyWeapons = true;
        this.usingMuskets = true;
        this.masterOfGunPowder = true;
    }
